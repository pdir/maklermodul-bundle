...
$GLOBALS['TL_LANG']['MSC']['prices'] = 'Цены';
$GLOBALS['TL_LANG']['MSC']['area'] = 'Области';
...
$GLOBALS['TL_LANG']['MSC']['contact'] = 'Связаться с';
...
$GLOBALS['TL_LANG']['MSC']['objectAddress'] = 'Адрес объекта';
$GLOBALS['TL_LANG']['MSC']['yes'] = 'Да';
$GLOBALS['TL_LANG']['MSC']['no'] = 'Нет';
$GLOBALS['TL_LANG']['MSC']['energyCertificate'] = 'Энергетический сертификат';
...
$GLOBALS['TL_LANG']['MSC']['filterReset'] = 'Сброс фильтра';
